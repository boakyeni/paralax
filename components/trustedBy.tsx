...
const TrustedBy: React.FC = () => (
    ...
    <div className="container mx-auto lg:max-w-[70%] lg:px-10">
        <h3 className="text-3xl lg:text-4xl tracking-tight text-center px-10 !leading-[3.5em]">We believe in spreading information that allows us to capture our entire experience</h3>
    </div>
    </div>
